			...
			<div class="row">
				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>YumYumTree Resturent</span></h1>
						<h4>          </h4>
						...
						<h2> Famous for its tasty food and food Delivery. We make sure you have great food
							 experience by offering highly palatable food at low price.  </h2>
						<!--<a class="btn btn-lg btn-circle btn-outline-new-white" href="#"> Comment</a> -->
					</div>
				</div>
				<div class="col-lg-6 col-md-6">
					<img src="images/logo-removebg.png" style="height: 450px; width: 100%" class="img-fluid">
				</div>
				<div class="col-md-12">
					<div class="inner-pt">
						<h2>Below is Our Menu.</h2>
					</div>
				</div>
			</div>
		</div>
