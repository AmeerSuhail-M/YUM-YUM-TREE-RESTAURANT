		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> YumYumTree Restaurant</strong></h1>
							<!-- <p class="m-b-40">Have It Your Way,   <br> 
							World's Greatest Hamburgers</p> -->
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/maher_restaurent/menu.php">Food Menu</a></p>
						</div>
					</div>
				</div>
			</li>
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>We like  <br> to serve you some great food.</strong></h1>
							<p class="m-b-40">YumYumTree Restaurant is serving Food for over 10 years and it has a very good and trained staff .</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/maher_restaurent/contact.php">Contact Us</a></p>
						</div>
					</div>
				</div>
			</li>
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> YumYumTree</strong></h1>
							<p class="m-b-40">Deliciousness jumping into the mouth<br> 
							We know our food..</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="/maher_restaurent/review.php">Review</a></p>
						</div>
					</div>
				</div>
			</li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>YumYumTree Restaurant</span></h1>
						<h4>Little Story</h4>
						<p> Making way for a hearty meal is YumYumTree Restaurant in Bangalore. 
							This place is synonymous with delicious food that can satiate all food cravings. 
							It is home to some of the most appreciated food dishes. 
							So as to be able to cater to a large number of diners.
							 This is a one of the renowned Restaurants in Bangalore.</p>
						<h2> Famous for its tasty food and food Delivery. We make sure you have great food
							 experience by offering highly palatable food at low price.  </h2><a class="btn btn-lg btn-circle btn-outline-new-white" href="/maher_restaurent/contact.php">Contact Us</a>
					</div>
				</div>
				<div class="col-lg-6 col-md-6 col-sm-12">
					<img src="images/logo-removebg.png"  width="200%" height="200%" class="img-fluid">
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					<p class="lead ">
						" If you're not the one cooking, sit and enjoy the food. "
					</p>
					<span class="lead">YumYumTree Restaurent</span>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="row inner-menu-box">
				<div class="col-3">
					<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
						...
						<a class="nav-link" id="v-pills-tava-tab" data-toggle="pill" href="#v-pills-tava" role="tab" aria-controls="v-pills-tava" aria-selected="false">South Indian</a>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for YumYumTree Restaurent Listed Here </p>
					</div>
				</div>
			</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Ramesh</strong></h5>
