...
{
?>
		<div style="background-color: pink; color: black; padding: 20px; font-size: 2.1em;">No Record Found please Add Products to Your Cart and then Continue to Check Out</div>
